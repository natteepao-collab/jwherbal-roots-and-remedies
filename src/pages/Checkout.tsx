...
import { QrCode, CreditCard, ArrowLeft, CheckCircle } from "lucide-react";
...
const checkoutSchema = z.object({
  ...
  payment_method: z.enum(["promptpay", "linepay"]),
});
              ...
              <Card className="bg-secondary mb-6">
                ...
                <CardContent>
                  <div className="bg-white p-4 rounded-lg inline-block mb-4">
                    ...
                    <div className="w-48 h-48 bg-gradient-to-br from-primary/20 to-primary/40 flex items-center justify-center rounded">
